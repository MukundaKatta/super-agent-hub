// super-agent-hub — skill-loader module
...
export class Skillloader extends EventEmitter {
  ...
  constructor(options: SkillloaderOptions = {}) {
    super();
    this.options = { name: options.name ?? "Skillloader", enabled: options.enabled ?? true, timeout: options.timeout ?? 30000 };
  }
  ...
  async process(input: unknown): Promise<SkillloaderResult> {
